...
function routesConfig($stateProvider, $locationProvider, $urlRouterProvider, helper) {
    ...
    $urlRouterProvider.otherwise("Paises/IndexView");
    ...
    $stateProvider
      ...
      .state("app.administracionPaises",
      {
          url: "/Paises/IndexView",
          title: "Paises",
          templateUrl: helper.basepath("Paises/IndexView"),
     ...
     .state("app.administracionFabricantes",
      {
        ...
        .state("app.administracionLineasProductos",
      {
          url: "/LineasProductos/IndexView",
          title: "LineasProductos",
          templateUrl: helper.basepath("LineasProductos/IndexView"),
          resolve: helper.resolveFor("smart-table")
      })
        .state("app.administracionTiposProductos",
      {
          url: "/TiposProductos/IndexView",
          title: "TiposProductos",
          templateUrl: helper.basepath("TiposProductos/IndexView"),
          resolve: helper.resolveFor("smart-table")
      }).state("app.administracionMarcasTiposProductos",
      {
          url: "/MarcasTiposProductos/IndexView",
          title: "MarcasTiposProductos",
          templateUrl: helper.basepath("MarcasTiposProductos/IndexView"),
          resolve: helper.resolveFor("smart-table")
      })
    ...
    $stateProvider.state("state-pais-PaisesAddView",
   {
       url: "/Paises/PaisesAddView",
       abstract: false,
       views: {
           modalCore: {
               templateUrl: helper.basepath("Paises/PaisesAddView"),
    ...
    $stateProvider.state("state-pais-PaisesEditView",
    {
        url: "/Paises/PaisesEditView",
        abstract: false,
        views: {
            modalCore: {
                templateUrl: helper.basepath("Paises/PaisesEditView"),
