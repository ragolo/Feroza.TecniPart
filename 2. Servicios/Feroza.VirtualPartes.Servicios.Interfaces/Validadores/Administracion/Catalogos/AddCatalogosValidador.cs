...
namespace Feroza.VirtualPartes.Servicios.Interfaces.Validadores.Administracion.Catalogos
{
    ...
    public class AddCatalogosValidador : AbstractValidator<Catalogos>
    {
        ...
        private readonly IRepositorio<Catalogos> catalogosRepository;
        ...
        public AddCatalogosValidador(IRepositorio<Catalogos> catalogosRepository)
        {
        ...
        {
            return this.catalogosRepository.ObtenerPorId(idCatalogos) == null;
        }
    }
}