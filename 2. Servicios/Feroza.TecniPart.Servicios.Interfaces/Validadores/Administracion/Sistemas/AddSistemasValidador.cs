...
namespace Feroza.TecniPart.Servicios.Interfaces.Validadores.Administracion.Sistemas
{
    using System.Linq;
    ...
    public class AddSistemasValidador : AbstractValidator<Sistemas>
    {
        ...
        private readonly IRepository<Sistemas> sistemasRepository;
        ...
        public AddSistemasValidador(IRepository<Sistemas> sistemasRepository)
        {
        ...
        {
            return this.sistemasRepository.GetById(idSistemas) == null;
        }
        ...
        {
            return !this.sistemasRepository.GetFiltered(r => r.Descripcion.Equals(descripcion)).Any();
        }
    }
}